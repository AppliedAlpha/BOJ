...
int visited[100003] = {0, }; // visited[i] = count i in range
int all_c[100003] = {0, }; // all_c[i] = count "count = i"
...
/* What is Mo's Algorithm?
   Also Used In Offline Query (No Changes)
   Well Done TRY
*/
...
int main() {
    ...
    sort(query.begin(), query.end()); // sort queries in defined order (operator)
